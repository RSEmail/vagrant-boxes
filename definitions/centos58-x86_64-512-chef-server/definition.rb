Veewee::Session.declare({
  ...
  :iso_src => "http://mirror.cs.vt.edu/pub/CentOS/5.8/isos/x86_64/CentOS-5.8-x86_64-bin-DVD-1of2.iso",
  ...
  #:boot_wait => "10", :boot_cmd_sequence => [ '<Tab> text ks=http://10.0.2.2:7122/ks.cfg<Enter>' ],
